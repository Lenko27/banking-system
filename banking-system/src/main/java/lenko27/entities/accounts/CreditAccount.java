...
/**
 * This class represents a credit account in the banking system.
...
public class CreditAccount extends Account {
    ...
    /**
     * Constructor for the CreditAccount class.
     *
     ...
     */
    public CreditAccount(UUID id, Bank bank, Client client) {
        this.id = id;
        this.bank = bank;
        this.client = client;
    }
     ...
     */
    @Override
    public boolean withdraw(double sum, boolean toLog) throws InsufficientFundsException, UnauthorizedTransactionException {
        if (balance < sum && sum - balance > bank.getCreditLimit()) {
